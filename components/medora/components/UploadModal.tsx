...
export const UploadModal: React.FC<UploadModalProps> = ({
  ...
  const handleFileDrop = (e: React.DragEvent) => {
    e.preventDefault();
    setDragOver(false);
    // For demo purposes, pick the first sample or user selected
    const chosen = SAMPLE_DOCUMENTS.find((d) => d.id === selectedDemoId) || SAMPLE_DOCUMENTS[0];
    handleSimulatedUpload(chosen);
  };
